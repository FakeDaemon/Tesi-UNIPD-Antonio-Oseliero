...
\begin{itemize}
      ...
      \item \textbf{Comunicazione}: 3CX agisce come canale di comunicazione per la maggior parte delle comunicazioni interne. 
            ...
            per comunicare con persone esterne all'azienda o per alcune \textit{mail} interne (\textbf{comunicazioni di servizio, 
      ...
      \item \textbf{Sviluppo}: Per quanto riguarda lo sviluppo gli strumenti utilizzati e le tecnologie impiegate variano 
            ...
            progetto verranno discusse in un capitolo a parte \ref{chap:vincoli tec}) ho preferito utilizzare Visual Studio perché offre 
      ...
      \item \textbf{Testing}: anche qui gli strumenti utilizzati dipendono dal progetto che si sta sviluppando. Nel mio 
            ...
            progetto verranno discusse in un capitolo a parte \ref{chap:vincoli tec}, mentre per la descrizione accurata di come ho 
      ...
      \item \textbf{Collaborazione e gestione del codice}: Bitbucket viene utilizzato come piattaforma per depositare il codice 
            ...
            \textit{branch} attivi: \textbf{\textit{main}} che contiene l'ultima versione rilasciata al pubblico del \textit{software}, 
